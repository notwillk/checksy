...
- **Unit location**: Bottom of each file in `#[cfg(test)]` module
- **Integration location**: `tests/` at the product root
...
### Test Data
- **Fixtures**: YAML configs in the product's `fixtures/` directory
